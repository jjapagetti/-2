...
#define STATUS_HEIGHT MAP_HEIGHT
#define MESSAGE_WIDTH MAP_WIDTH
#define MESSAGE_HEIGHT 5
#define COMMAND_WIDTH  STATUS_WIDTH
#define COMMAND_HEIGHT MESSAGE_HEIGHT



// 출력 시작 위치
const POSITION status_pos = { 1, MAP_WIDTH + 2 };
const POSITION message_pos = { MAP_HEIGHT + 1, 0 };
...
typedef struct {
	...
	char repr;	
	int speed; // 화면에 표시할 문자(representation)
